...
public class MorishitaTest extends MorishitaTestBase {
	...
	public void scenarioTest002() {
		...
		final String employeeId = "aaaaa";
		final String hireDate = "0020220401";
		final String birthDate = "0019971208";
		inputOtherEmployeeInfo(employeeId, hireDate, birthDate);
		// 登録
		click("//*[@id=\"upload\"]");
		//メッセージバー確認
		assertMessageBar("従業員情報の登録が完了しました。");
		assertPageTitle("/html/body/div[2]/div[1]/h1", "従業員情報詳細");
